...
def main():
    task_generated_nolead = [None]*3  # 7
    task_succ_exe_nolead = [None]*3   # 8
    tasks_failed_delay_nolead = [None]*3   # 10
    tasks_failed_mobility_nolead = [None]*3   # 12
    ...
    task_generated_lead = [None] * 3  # 8
    task_succ_exe_lead = [None] * 3  # 10
    tasks_failed_delay_lead = [None] * 3  # 12
    tasks_failed_mobility_lead = [None] * 3  # 14
    ...
    plt.plot(edge_num, task_succ_exe_lead, label="% Tasks successfully excuted LEAD")
    plt.plot(edge_num, tasks_failed_delay_lead, label="% Tasks failed due to delay LEAD")
    plt.plot(edge_num, tasks_failed_mobility_lead, label="% Tasks failed due to mobility LEAD")
    # naming the x axis
