...
public class MainApplication extends MainApplicationAbstract{
	...
	public static void launchSimulation() {
		SimLog.println("MyMain- Loading simulation files...");
		...
		SimLog.println("MyMain- Simulation took : " + simulationTime(startDate, endDate));
		SimLog.println("MyMain- results were saved to the folder: " + outputFolder);
	...
	public void startSimulation() {
		...
		try { // Repeat the operation for different number of devices
			...
			e.printStackTrace();
			SimLog.println("MyMain- The simulation has been terminated due to an unexpected error");
		}
	}
	...
	protected void generateCharts(SimLog simLog) {
		if (SimulationParameters.SAVE_CHARTS && !SimulationParameters.PARALLEL && simLog != null) {
			SimLog.println("MyMain- Saving charts...");
