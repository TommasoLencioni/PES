...
def main():
    ...
    for simulation_folder in os.listdir('not_moving/50_users/NOLEAD'):
        for simulations_file in os.listdir('not_moving/50_users/NOLEAD/' + simulation_folder):
            if simulations_file == 'Parallel_simulation_1.csv':
                f_csv = csv.reader(open('not_moving/50_users/NOLEAD/' + simulation_folder + '/' + simulations_file),
                                   delimiter=",")
    ...
    tasks_failed_delay_nolead[0] = int(numpy.average(tasks_failed_delay)) / int(numpy.average(tasks_generated)) * 100
    ...
    tasks_succ_exe_cloud = list()  # 15
    tasks_succ_exe_edge = list()  # 17
    for simulation_folder in os.listdir('not_moving/100_users/NOLEAD'):
        for simulations_file in os.listdir('not_moving/100_users/NOLEAD/' + simulation_folder):
            if simulations_file == 'Parallel_simulation_1.csv':
                f_csv = csv.reader(open('not_moving/100_users/NOLEAD/' + simulation_folder + '/' + simulations_file),
                                   delimiter=",")
                for i, line in enumerate(f_csv):
                    if i == 1:
                        for j, elem in enumerate(line):
    ...
    tasks_failed_delay_nolead[1] = int(numpy.average(tasks_failed_delay)) / int(numpy.average(tasks_generated)) * 100
    ...
    tasks_succ_exe_cloud = list()  # 15
    tasks_succ_exe_edge = list()  # 17
    for simulation_folder in os.listdir('not_moving/150_users/NOLEAD'):
        for simulations_file in os.listdir('not_moving/150_users/NOLEAD/' + simulation_folder):
            if simulations_file == 'Parallel_simulation_1.csv':
                f_csv = csv.reader(open('not_moving/150_users/NOLEAD/' + simulation_folder + '/' + simulations_file),
                                   delimiter=",")
                for i, line in enumerate(f_csv):
                    if i == 1:
                        for j, elem in enumerate(line):
    ...
    tasks_failed_delay_nolead[2] = int(numpy.average(tasks_failed_delay)) / int(numpy.average(tasks_generated)) * 100
    ...
    tasks_succ_exe_cloud = list()  # 15
    tasks_succ_exe_edge = list()  # 17
    for simulation_folder in os.listdir('not_moving/200_users/NOLEAD'):
        for simulations_file in os.listdir('not_moving/200_users/NOLEAD/' + simulation_folder):
            if simulations_file == 'Parallel_simulation_1.csv':
                f_csv = csv.reader(open('not_moving/200_users/NOLEAD/' + simulation_folder + '/' + simulations_file),
                                   delimiter=",")
                for i, line in enumerate(f_csv):
                    if i == 1:
                        for j, elem in enumerate(line):
    ...
    tasks_failed_delay_nolead[3] = int(numpy.average(tasks_failed_delay)) / int(numpy.average(tasks_generated)) * 100
...
########################################################################################################################
    ...
    tasks_succ_exe_cloud = list()  # 15
    tasks_succ_exe_edge = list()  # 17
    for simulation_folder in os.listdir('not_moving/50_users/LEAD'):
        for simulations_file in os.listdir('not_moving/50_users/LEAD/' + simulation_folder):
            if simulations_file == 'Parallel_simulation_1.csv':
                f_csv = csv.reader(open('not_moving/50_users/LEAD/' + simulation_folder + '/' + simulations_file),
                                   delimiter=",")
                for i, line in enumerate(f_csv):
                    if i == 1:
                        for j, elem in enumerate(line):
    ...
    tasks_succ_exe_cloud = list()  # 15
    tasks_succ_exe_edge = list()  # 17
    for simulation_folder in os.listdir('not_moving/100_users/LEAD'):
        for simulations_file in os.listdir('not_moving/100_users/LEAD/' + simulation_folder):
            if simulations_file == 'Parallel_simulation_1.csv':
                f_csv = csv.reader(open('not_moving/100_users/LEAD/' + simulation_folder + '/' + simulations_file),
                                   delimiter=",")
                for i, line in enumerate(f_csv):
                    if i == 1:
                        for j, elem in enumerate(line):
    ...
    tasks_succ_exe_cloud = list()  # 15
    tasks_succ_exe_edge = list()  # 17
    for simulation_folder in os.listdir('not_moving/150_users/LEAD'):
        for simulations_file in os.listdir('not_moving/150_users/LEAD/' + simulation_folder):
            if simulations_file == 'Parallel_simulation_1.csv':
                f_csv = csv.reader(open('not_moving/150_users/LEAD/' + simulation_folder + '/' + simulations_file),
                                   delimiter=",")
                for i, line in enumerate(f_csv):
                    if i == 1:
                        for j, elem in enumerate(line):
    ...
    tasks_succ_exe_cloud = list()  # 15
    tasks_succ_exe_edge = list()  # 17
    for simulation_folder in os.listdir('not_moving/200_users/LEAD'):
        for simulations_file in os.listdir('not_moving/200_users/LEAD/' + simulation_folder):
            if simulations_file == 'Parallel_simulation_1.csv':
                f_csv = csv.reader(open('not_moving/200_users/LEAD/' + simulation_folder + '/' + simulations_file),
                                   delimiter=",")
                for i, line in enumerate(f_csv):
                    if i == 1:
                        for j, elem in enumerate(line):
...
#######################################################################################################################
    ...
    tasks_succ_exe_cloud = list()  # 15
    tasks_succ_exe_edge = list()  # 17
    for simulation_folder in os.listdir('not_moving/50_users/NEIGH'):
        for simulations_file in os.listdir('not_moving/50_users/NEIGH/' + simulation_folder):
            if simulations_file == 'Parallel_simulation_1.csv':
                f_csv = csv.reader(open('not_moving/50_users/NEIGH/' + simulation_folder + '/' + simulations_file),
                                   delimiter=",")
                for i, line in enumerate(f_csv):
                    if i == 1:
                        for j, elem in enumerate(line):
    ...
    tasks_failed_delay_neigh[0] = int(numpy.average(tasks_failed_delay)) / int(numpy.average(tasks_generated)) * 100
    ...
    tasks_succ_exe_cloud = list()  # 15
    tasks_succ_exe_edge = list()  # 17
    for simulation_folder in os.listdir('not_moving/100_users/NEIGH'):
        for simulations_file in os.listdir('not_moving/100_users/NEIGH/' + simulation_folder):
            if simulations_file == 'Parallel_simulation_1.csv':
                f_csv = csv.reader(open('not_moving/100_users/NEIGH/' + simulation_folder + '/' + simulations_file),
                                   delimiter=",")
                for i, line in enumerate(f_csv):
                    if i == 1:
                        for j, elem in enumerate(line):
    ...
    tasks_failed_delay_neigh[1] = int(numpy.average(tasks_failed_delay)) / int(numpy.average(tasks_generated)) * 100
    ...
    tasks_succ_exe_cloud = list()  # 15
    tasks_succ_exe_edge = list()  # 17
    for simulation_folder in os.listdir('not_moving/150_users/NEIGH'):
        for simulations_file in os.listdir('not_moving/150_users/NEIGH/' + simulation_folder):
            if simulations_file == 'Parallel_simulation_1.csv':
                f_csv = csv.reader(open('not_moving/150_users/NEIGH/' + simulation_folder + '/' + simulations_file),
                                   delimiter=",")
                for i, line in enumerate(f_csv):
                    if i == 1:
                        for j, elem in enumerate(line):
    ...
    tasks_failed_delay_neigh[2] = int(numpy.average(tasks_failed_delay)) / int(numpy.average(tasks_generated)) * 100
    ...
    tasks_succ_exe_cloud = list()  # 15
    tasks_succ_exe_edge = list()  # 17
    for simulation_folder in os.listdir('not_moving/200_users/NEIGH'):
        for simulations_file in os.listdir('not_moving/200_users/NEIGH/' + simulation_folder):
            if simulations_file == 'Parallel_simulation_1.csv':
                f_csv = csv.reader(open('not_moving/200_users/NEIGH/' + simulation_folder + '/' + simulations_file),
                                   delimiter=",")
                for i, line in enumerate(f_csv):
                    if i == 1:
                        for j, elem in enumerate(line):
    ...
    tasks_failed_delay_neigh[3] = int(numpy.average(tasks_failed_delay)) / int(numpy.average(tasks_generated)) * 100
    ...
    plt.plot(users_num, tasks_succ_exe_nolead, label="Non-federated", marker='o')
    plt.plot(users_num, tasks_succ_exe_lead, label="Federated", marker='^')
    plt.plot(users_num, tasks_succ_exe_neigh, label="Neighbor", marker='.')
    plt.xlabel('Number of users')
    plt.ylabel('% of successfully executed tasks over tasks sent')
    plt.gcf().set_size_inches(12, 6)
    #plt.title('Successfully executed')
    ...
    plt.plot(users_num, tasks_failed_delay_nolead, label="Non-federated", marker='o')
    plt.plot(users_num, tasks_failed_delay_lead, label="Federated", marker='^')
    plt.plot(users_num, tasks_failed_delay_neigh, label="Neighbor", marker='.')
    plt.xlabel('Number of users')
    plt.ylabel('% of failed tasks due to total latency over task sent')
    plt.gcf().set_size_inches(12, 6)
    ...
    plt.plot(users_num, tasks_failed_mobility_nolead, label="Non-federated", marker='o')
    plt.plot(users_num, tasks_failed_mobility_lead, label="Federated", marker='^')
    plt.plot(users_num, tasks_failed_mobility_neigh, label="Neighbor", marker='.')
    plt.xlabel('Number of users')
    ...
    plt.plot(users_num, tasks_succ_exe_cloud_nolead, label="Non-federated", marker='o')
    plt.plot(users_num, tasks_succ_exe_cloud_lead, label="Federated", marker='^')
    plt.plot(users_num, tasks_succ_exe_cloud_neigh, label="Neighbor", marker='.')
    plt.xlabel('Number of users')
    ...
    plt.plot(users_num, tasks_succ_exe_edge_nolead, label="Non-federated", marker='o')
    plt.plot(users_num, tasks_succ_exe_edge_lead, label="Federated", marker='^')
    plt.plot(users_num, tasks_succ_exe_edge_neigh, label="Neighbor", marker='.')
    plt.xlabel('Number of users')
    ...
    plt.plot(users_num, tasks_failed_delay_nolead, label="% Tasks failed due to delay NOLEAD")
