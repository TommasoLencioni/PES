...
########################################################################################################################
    ...
    plt.plot(users_num, tasks_failed_latency_neigh, label="Neighbour", marker='o')
    plt.xlabel('Number of users')
    ...
    plt.plot(users_num, tasks_failed_mobility_neigh, label="Neighbour", marker='o')
    plt.xlabel('Number of users')
    ...
    plt.plot(users_num, tasks_succ_exe_cloud_neigh, label="Neighbour", marker='o')
    plt.xlabel('Number of users')
    ...
    plt.plot(users_num, tasks_succ_exe_edge_neigh, label="Neighbour", marker='o')
    plt.xlabel('Number of users')
