...
This class isn't extendable so I had to modify it directly.\\
...
my\_findVM is called only in edgeAndCloud method because in other architecture there are less or more devices than needed to work.\\\\
